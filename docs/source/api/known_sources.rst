...
* **Satellites**: Satellites loaded from TLE files using the sgp4 package
* **Stars**: Stars loaded via the astroquery package. Currently supported catalogs are Hipparcos and Gaia.
